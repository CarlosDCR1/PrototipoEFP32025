...
int APLICACION=301;
    ...
    public void llenadoDeCombos() {
        ...
        for (int i = 0; i < salon.size(); i++) {
            cbox_empleado.addItem(salon.get(i).getNombre());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < aulas.size(); i++) {
            dato[0] = aulas.get(i).getPkId();
            //dato[0] = aulas.get(i).getId_aplicacion();
            dato[1] = aulas.get(i).getIdTipoBodega();
            dato[2] = aulas.get(i).getNombre();
            dato[3] = aulas.get(i).getDireccion();
            dato[4] = aulas.get(i).getEstatus_aplicacion();
    ...
    public void buscarVendedor() {
        ...
        AplicacionDAO aplicacionDAO = new AplicacionDAO();
        aplicacionAConsultar.setPkId(txtbuscado.getText());
        aplicacionAConsultar = aplicacionDAO.query(aplicacionAConsultar);
        txtTipoB.setText(aplicacionAConsultar.getIdTipoBodega());
        txtNombre.setText(aplicacionAConsultar.getNombre());
        txtdirec.setText(aplicacionAConsultar.getDireccion());
        txtEstatus.setText(aplicacionAConsultar.getEstatus_aplicacion());
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(UsuarioConectado.getIdUsuario(), APLICACION,  "Buscar BODEGA EF");    
    ...
    private void initComponents() {
        ...
        txtTipoB.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtTipoB.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(204, 204, 204)));
        ...
        tablaAula.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pk ID", "Id Tipo Bodega", "Nombre", "Direccion", "Estatus"
            }
        ) {
        ...
        txtdirec.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtdirec.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(204, 204, 204)));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtTipoB, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(label6)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(label8)
                        .addGap(29, 29, 29)
                        .addComponent(txtdirec, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        aplicacionAEliminar.setPkId(txtbuscado.getText());
        aplicacionDAO.delete(aplicacionAEliminar);
        llenadoDeTablas();
         UsuarioConectado usuarioEnSesion = new UsuarioConectado();
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(usuarioEnSesion.getIdUsuario(), APLICACION,  "Eliminar BODEGA EF");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        aplicacionAInsertar.setPkId(txtid.getText());
        aplicacionAInsertar.setIdTipoBodega(txtTipoB.getText());
        aplicacionAInsertar.setNombre(txtNombre.getText());
        aplicacionAInsertar.setDireccion(txtdirec.getText());
        ...
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(usuarioEnSesion.getIdUsuario(), APLICACION,  "Insertar BODEGA EF");
...
//        // TODO add your handling code here:
        ...
        aplicacionAActualizar.setPkId(txtbuscado.getText());
        aplicacionAActualizar.setIdTipoBodega(txtTipoB.getText());
        aplicacionAActualizar.setNombre(txtNombre.getText());
        aplicacionAActualizar.setDireccion(txtdirec.getText());
        aplicacionAActualizar.setEstatus_aplicacion(txtEstatus.getText());
        aplicacionDAO.update(aplicacionAActualizar);
        llenadoDeTablas();
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(UsuarioConectado.getIdUsuario(), APLICACION,  "Modificar BODEGA EF");    
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        int resultadoBitacora=0;
        Bitacora bitacoraRegistro = new Bitacora();
        resultadoBitacora = bitacoraRegistro.setIngresarBitacora(UsuarioConectado.getIdUsuario(), APLICACION,  "Limpiar BODEGA EF");    
